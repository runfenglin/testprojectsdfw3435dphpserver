  ...
  return {
    ...
    link:function (scope, element, attrs, controller) {
      ...
      var initDateWidget = function () {
        ...
        // set maxRestrict, minRestrict, maxDate, minDate
		var onSelectCallbacks = [];
		
		if (attrs.minRestrict) {
			onSelectCallbacks.push(function (selectedDate) {
				angular.element(attrs.minRestrict).datepicker('option', 'minDate', selectedDate);
			});
		}
		if (attrs.maxRestrict) {
			onSelectCallbacks.push(function (selectedDate) {
				angular.element(attrs.maxRestrict).datepicker('option', 'maxDate', selectedDate);
			});
		}
